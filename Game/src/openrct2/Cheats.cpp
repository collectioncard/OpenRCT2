...
void CheatsReset()
{
    ...
    gameState.cheats.disableBrakesFailure = true;
    gameState.cheats.disableAllBreakdowns = true;
    gameState.cheats.buildInPauseMode = false;
    gameState.cheats.ignoreRideIntensity = false;
    gameState.cheats.ignorePrice = false;
    gameState.cheats.disableVandalism = true;
    gameState.cheats.disableLittering = true;
    gameState.cheats.neverendingMarketing = false;
    gameState.cheats.freezeWeather = true;
    gameState.cheats.disablePlantAging = true;
